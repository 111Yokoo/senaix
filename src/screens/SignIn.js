    ...
    <View style={style.container}>
      ...
      <View style={{gap: 16}}>
        <View style={style.inputBox}>
          ...
          <TextInput placeholder="Email" placeholderTextColor="#8a8787" keyboardType="email-adress" style={style.input}/>
        </View>
        <View style={style.inputBox}>
          <Feather name="lock" size={32} color="#8a8787"/>
          <TextInput placeholder="Digite sua senha" placeholderTextColor="#8a8787" secureTextEntry style={style.input}/>
        </View>
